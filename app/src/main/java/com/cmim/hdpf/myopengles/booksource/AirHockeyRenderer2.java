...
public class AirHockeyRenderer2 implements Renderer {
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
        ...
        int vertexShader = ShaderHelper.INSTANCE.compileVertexShader(vertexShaderSource);
        int fragmentShader = ShaderHelper.INSTANCE
            .compileFragmentShader(fragmentShaderSource);

        program = ShaderHelper.INSTANCE.linkProgram(vertexShader, fragmentShader);

        if (LoggerConfig.ON) {
            ShaderHelper.INSTANCE.validateProgram(program);
        }
