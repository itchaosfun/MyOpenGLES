...
***/
package com.cmim.hdpf.myopengles.booksource;
...
import com.cmim.hdpf.myopengles.util.LoggerConfig;
import com.cmim.hdpf.myopengles.booksource.ShaderHelper1;
...
public class AirHockeyRenderer1 implements Renderer {
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
        ...
        int vertexShader = ShaderHelper1.compileVertexShader(vertexShaderSource);
        int fragmentShader = ShaderHelper1.compileFragmentShader(fragmentShaderSource);

        program = ShaderHelper1.linkProgram(vertexShader, fragmentShader);

        if (LoggerConfig.ON) {
            ShaderHelper1.validateProgram(program);
        }
